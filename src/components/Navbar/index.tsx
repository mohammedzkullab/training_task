...
import { NAVIGATION, USER, USER_NAVIGATION } from "@/data/constants";
  ...
  return (
    <>
      <Disclosure as="nav" className="bg-gray-800">
        {({ open }) => (
          <>
            <div className="z-50 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div className="fixed bottom-0 left-0 z-50 w-full px-6 py-3 text-gray-800 bg-white shadow-sm md:hidden rounded-xl">
